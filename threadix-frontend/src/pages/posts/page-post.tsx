          ...
          {posts.map((post) => (
            <div key={post.postId} className="post">
              <div className="vote-section">
                <button className="vote-button upvote"><FaArrowUp /></button>
                <span className="vote-count">{post.likesCount}</span>
                <button className="vote-button downvote"><FaArrowDown /></button>
              </div>
              <div className="post-content">
                ...
                {post.imagePath && (
                  <img
                    src={`http://localhost:8080${post.imagePath}`} // Construct the image URL
                    alt="Post Image"
                ...
                <div className="post-info">
                  ...
                  <span className="post-comments"><FaCommentAlt /> 12 Comments</span>
                </div>
              </div>
            </div>
          ))}
